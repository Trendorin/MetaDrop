...
Інтерфейс використовує мову системи або одразу перемикається в налаштуваннях між англійською, російською, українською та німецькою.
...
Кожен бінарний пакет збирається та перевіряється встановленням у цільовій системі: Ubuntu 24.04, Fedora 44 або актуальній Arch Linux. Для складання з вихідного коду в релізі залишається `PKGBUILD`: `makepkg -si`.

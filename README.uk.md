<p align="center">
  <img src="docs/assets/hero.svg" width="100%" alt="MetaDrop — перегляд, очищення та перевірка метаданих">
</p>
...
<p align="center">
  ...
  <a href="#uninstall">Видалення</a> · <a href="SECURITY.md">Безпека</a> ·
...
|---|---|---|
| Підтримуваний Linux x86-64 | `MetaDrop-*-x86_64.AppImage` | `chmod +x MetaDrop-*.AppImage && ./MetaDrop-*.AppImage` |
...
|---|---|
| AppImage | Видаліть завантажений файл `MetaDrop-*-x86_64.AppImage` |
...
Докладніше: [модель безпеки](SECURITY.md), [обробка даних](PRIVACY.md), [сторонні компоненти](THIRD_PARTY_NOTICES.md).

## Проєкт

[Зміни](CHANGELOG.md) · [Участь](CONTRIBUTING.md) · [Автори](CONTRIBUTORS.md) · [Завдання](https://github.com/Trendorin/MetaDrop/issues)
